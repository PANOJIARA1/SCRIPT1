...
TP:Button("Rejoin",function()
    game:GetService'TeleportService':TeleportToPlaceInstance(game.PlaceId,game.JobId,game:GetService'Players'.LocalPlayer)
end)

local Wea = Tab2:royxpage("Weapon Giver")

Wea:Button("Glock",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(32.5, 12.5749989, 102.424995, 1, 0, 0, 0, 1, 0, 0, 0, 1)
	wait(.5)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(18, 10.5, -3, 1, 0, 0, 0, 1, 0, 0, 0, 1)
end)

Wea:Button("Minigun",function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(32.5, 32.5, 102.5, 0, 0, 1, 0, 1, -0, -1, 0, 0)
	wait(.5)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(18, 10.5, -3, 1, 0, 0, 0, 1, 0, 0, 0, 1)
end)

local ST = Tab3:royxpage("Setting Players")
ST:Slider("WalkSpeed",true,16,150,5,5,function(w)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = w
end)
ST:Slider("JumpPower",true,50,200,5,5,function(j)
